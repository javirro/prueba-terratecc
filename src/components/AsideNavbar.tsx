...
const AsideNavbar = ({ isHovered, setIsHovered }: {isHovered: boolean, setIsHovered: (s:boolean) => void}) => {
  ...
  return (
    ...
    <aside className="aside"  onMouseLeave={handleMouseLeave}>
      <section className="aside-container">
          <img src={logo} alt="logo" className="aside-img" />
        <article className="icon-container">
          <img src={asideIcon} alt="icon-1" className="aside-icon" onMouseEnter={handleMouseEnter} />
        </article>
        <article  className="icon-container">
          <img src={asideIcon2} alt="icon-2" className="aside-icon"  onMouseEnter={handleMouseEnter} />
        </article>
        <article  className="icon-container">
          <img src={asideIcon3} alt="icon-3" className="aside-icon" onMouseEnter={handleMouseEnter}  />
        </article>
      </section>
